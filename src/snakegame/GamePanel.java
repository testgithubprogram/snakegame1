...
public class GamePanel extends JPanel implements ActionListener , KeyListener{
    ...
    private int[] yPos={75,100,125,150,175,200,225,250,275,300,325,350,325,350,375,400,425,450,475,500,525,550,575,600,625};
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        for(int i=lengthOfSnake-1;i>0;i--){
            snakexlength[i]=snakexlength[i-1];          //H + B run
         ...
         if(snakexlength[0]>850)snakexlength[0]=25;      // pos con
         if(snakexlength[0]<25)snakexlength[0]=850;
         
         if(snakeylength[0]>625)snakeylength[0]=75;      // pos con
